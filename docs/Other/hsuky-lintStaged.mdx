...
tags: ["Other", "husky", "lint-staged", "eslint", "prettier", "stylelint"]
---

import { Img } from "@site/src/components/Width";
import image_1 from "/img/other/lint-staged-1.png";
import image_2 from "/img/other/commitlint-1.png";
import image_3 from "/img/other/lint-staged-2.gif";
import image_4 from "/img/other/lint-staged-3.png";
...
- [Plugins](https://stylelint.io/user-guide/plugins)：引入的第三方套件。
...
### 使用 Vscode Source Control 發 commit 問題踩雷
