...
<iframe
  src='https://codesandbox.io/embed/bitter-sun-cs7hlr?fontsize=14&hidenavigation=1&module=%2Fsrc%2Fstore%2Findex.js&view=split&initialpath=counter&theme=dark'
  style={{
    width: "100%",
    height: "400px",
    border: 0,
